...
int main (int argc, char **argv) {
  ...
  wstring line;
  wifstream text_file("/home/samuel/Summarizer/src/pp.txt");
  wstring text = L"";
  while (getline(text_file, line))
      text += line + L"\n";

  wifstream analyzed_text_file("/home/samuel/Summarizer/src/pp.out");
  
  getline(analyzed_text_file, line);
  wstring an_text = line;
  while (getline(analyzed_text_file, line))
      an_text += L"\n" + line;
